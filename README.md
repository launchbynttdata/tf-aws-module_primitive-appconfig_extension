# Terraform AWS Module: AppConfig Extension (Primitive)
...
This primitive module manages one AWS AppConfig extension resource and exposes the commonly used Terraform provider arguments for composition by collection and reference architecture modules.

## Usage

```hcl
module "example" {
  source = "terraform.registry.launch.nttdata.com/module_primitive/appconfig_extension/aws"
...
| Name | Type |
|------|------|
| [aws_appconfig_extension.extension](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/appconfig_extension) | resource |

## Inputs

| Name | Description | Type | Default | Required |
|------|-------------|------|---------|:--------:|
| <a name="input_action_points"></a> [action\_points](#input\_action\_points) | Action points and actions for the extension. Each action point must include at least one action. | <pre>list(object({<br/>    point = string<br/>    actions = list(object({<br/>      name        = string<br/>      uri         = string<br/>      description = optional(string)<br/>      role_arn    = optional(string)<br/>    }))<br/>  }))</pre> | n/a | yes |
| <a name="input_description"></a> [description](#input\_description) | Description of the AppConfig extension. Must be at most 1024 characters. | `string` | `null` | no |
| <a name="input_name"></a> [name](#input\_name) | Name of the AppConfig extension. Must be 1 to 64 characters. | `string` | n/a | yes |
| <a name="input_parameters"></a> [parameters](#input\_parameters) | Parameters accepted by the extension. | `list(object({ name = string, description = optional(string), required = optional(bool) }))` | `[]` | no |
