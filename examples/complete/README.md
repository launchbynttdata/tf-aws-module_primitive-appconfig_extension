...
This example creates a complete AppConfig extension deployment with the dependencies required to exercise the primitive module.
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_extension"></a> [extension](#module\_extension) | ../.. | n/a |
...
| <a name="input_description"></a> [description](#input\_description) | Extension description. | `string` | `"Example AppConfig extension."` | no |
...
| <a name="output_expected_name"></a> [expected\_name](#output\_expected\_name) | Expected extension name. |
